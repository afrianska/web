...
title: 'Design Case Study: Nutritious Food Precurement Government'
image:
    src: 'https://miro.medium.com/v2/resize:fit:2000/format:webp/1*XtZwkwbuDdFyXLUi0zCE_g.png'
    alt: 'he Astro logo on a dark background with a pink glow.'
pubDate: '2020-04-16'
...
tags: ["design", "ux", "ui", "study case"]
---

IMRAD [Introduction, Methods, Result, Disscussion, Reference]
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*WCsOG2i4xsfLQ4Yr6uH7lA.png)
<figcaption>Project Map from begin to end experiences</figcaption>

Information list about user does, feels and pain in sticky notes like below:

![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*HWw9m5Axxu5b3cH-HXAwxg.png)
<figcaption>Sticky Notes</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*3XN-JObcK33zZwENwqFXWQ.png)
<figcaption>The picture of affinity diagram in above i just take data of: user do, think & say; because other data like: feel, need and pain; not had significant different.</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*iMDM-xlQoLsw2xGQrI2g5g.png)
<figcaption>Primary User Persona</figcaption>

![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*PyNj3zNh_ynT83YvhwL8Ow.png)
<figcaption>Secondary User Persona</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:1100/format:webp/1*V2DFriX5je07tg8bSXG9aw.jpeg)
<figcaption>User Map Journey</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*CLmguJ2EX_pch8Cc1Yt8vg.jpeg)
<figcaption>Application Map (site map)</figcaption>

Also, design user flow to give a general image about how interaction happened when using this product.

![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*4MwKBHTVMGRRSQ_4TG8i9g.png)
<figcaption>User Flow, for see complete this you can visit this link: https://bit.ly/2RUEKxN</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*s4iTpnL_4hrQg0LHPkEudQ.jpeg)
<figcaption>Low-fidelity sketches of screens</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:2000/format:webp/1*QGdrTzJPUUJRBmxX3r7GGg.png)
<figcaption>Some low-fidelity wireframes create in app design.</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:640/format:webp/1*reiTl4SW_DtXCbRBcqfERw.png)
<figcaption>Color picking</figcaption>

To make some screens more interesting and informative for users, I try to create some illustrations.

![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*KgV6r3USVt2nKx_DmIvS9g.png)
<figcaption>some illustration for app</figcaption>
...
![Image Alt Text](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*wFucUAPn0om88xZntoUvGQ.png)
<figcaption>Some High-fidelity screen of App</figcaption>
...
**Everyone can access the prototype of this study case [HERE](https://www.figma.com/community/file/1269175758691914592)**
